...
description: >-
  Segment users from feedback data based on behavior, JTBD, and needs. Identifies at least 3 distinct user segments. USE FOR: segmenting a user base, analyzing diverse user feedback, or building a segmentation model.
---
