...
description: >-
  Create a comprehensive product strategy using the 9-section Product Strategy Canvas — vision, segments, costs, value propositions, trade-offs, metrics, growth, capabilities, and defensibility. USE FOR: building a product strategy, creating a strategic plan, or defining product direction.
---
