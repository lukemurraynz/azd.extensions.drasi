...
name: azure-adr
description: >-
  Create formal Azure Architecture Decision Records with WAF pillar mapping,
  alternatives analysis, consequences, and implementation guidance.
  USE FOR: documenting architecture decisions, recording technology choices,
  capturing decision rationale, or creating ADRs from assessment findings.
...
- [WAF Assessment](../waf-assessment/SKILL.md) — Well-Architected Framework assessments referenced in ADRs
- [Azure Defaults](../azure-defaults/SKILL.md) — Standard resource configurations for implementation notes
- [Cost Optimization](../cost-optimization/SKILL.md) — Cost trade-off analysis for decision records
...
- **Authoritative references:** [Azure Architecture Decision Records](https://learn.microsoft.com/azure/architecture/), [WAF pillars](https://learn.microsoft.com/azure/well-architected/)

### Verification Steps

1. Confirm ADR template structure aligns with current Azure Architecture Center guidance
2. Verify WAF pillar names and categories are current
3. Check for new ADR tooling or template standards
