...
- [ ] Includes a "currency and verification" section for fast-moving ecosystems
- [ ] Version-dependent claims include explicit verification guidance and authoritative references
...
- [ ] At least one official source (docs/changelog/release notes) reviewed within current quarter
