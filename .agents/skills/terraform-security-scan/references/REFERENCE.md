...
### Trivy (Recommended — replaces deprecated tfsec)

> **NOTE:** `tfsec` has a published migration path to Trivy. Prefer Trivy for new IaC scanning workflows. Use Trivy for all IaC scanning.
...
trivy config . --skip-dirs .terraform --ignorefile .trivyignore
...
**Scanner:** trivy + checkov + manual review
