...
name: wwas
description: >-
  Create product backlog items in Why-What-Acceptance format (independent, valuable, testable items with strategic context). USE FOR: writing structured backlog items, breaking features into work items, or using the WWA format.
---
