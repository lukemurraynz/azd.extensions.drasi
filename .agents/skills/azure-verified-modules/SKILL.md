...
description: >-
  Research and learn from Azure Verified Modules (AVM) patterns to build better
  custom Terraform modules.
  USE FOR: creating Terraform modules, researching Azure security defaults,
  understanding resource configuration patterns, finding Microsoft reference
  implementations, or studying AVM examples.
metadata:
...
- [Terraform Security Scan](../terraform-security-scan/SKILL.md) — Security scanning for IaC
...
- **Sources:** [Azure Verified Modules registry](https://github.com/Azure/bicep-registry-modules/tree/main/avm/res), Microsoft Learn MCP
- **Authoritative references:** [AVM documentation](https://azure.github.io/Azure-Verified-Modules/), [AVM Terraform index](https://raw.githubusercontent.com/Azure/Azure-Verified-Modules/refs/heads/main/docs/static/module-indexes/TerraformResourceModules.csv)

### Verification Steps

1. Confirm AVM module naming and registry conventions are unchanged
2. Verify AVM Terraform module index URL is accessible and current
3. Check for new AVM pattern modules or breaking changes to module interfaces
