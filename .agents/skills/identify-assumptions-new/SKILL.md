...
description: >-
  Identify risky assumptions for a new product idea across 8 risk categories including Go-to-Market, Strategy, and Team. USE FOR: evaluating startup risks, assessing a new product concept, or mapping assumptions for a new venture.
---
