...
description: >-
  Prioritize assumptions using an Impact × Risk matrix and suggest experiments for each. USE FOR: triaging a list of assumptions, deciding what to test first, or applying the assumption prioritization canvas.
---
