...
name: waf-assessment
description: >-
  Assess Azure architectures against the Well-Architected Framework five pillars
  with scored evaluations and prioritized recommendations.
  USE FOR: evaluating architecture readiness, validating WAF compliance,
  identifying reliability or security gaps, scoring pillar maturity,
  or reviewing designs before production deployment.
---
...
- [Cost Optimization](../cost-optimization/SKILL.md) — Deep-dive cost analysis for the Cost Optimization pillar
- [Azure ADR](../azure-adr/SKILL.md) — Document architectural decisions from WAF findings
- [Azure Defaults](../azure-defaults/SKILL.md) — Baseline security and configuration standards
- [Azure Troubleshooting](../azure-troubleshooting/SKILL.md) — Diagnose issues identified during assessments
...
- **Authoritative references:** [Azure Well-Architected Framework](https://learn.microsoft.com/azure/well-architected/)

### Verification Steps

1. Confirm WAF pillar names and assessment methodology are current
2. Verify Azure Advisor recommendation categories align with skill guidance
3. Check for new WAF workbooks or assessment tools
