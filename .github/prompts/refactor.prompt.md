...
6. Surface trade-offs honestly ("The catch:", "The gotcha:") rather than presenting refactorings as pure wins
7. Distinguish between decisions that are hard to change later vs easy to revisit
8. Value what works in production over theoretical perfection; warn against premature optimization
