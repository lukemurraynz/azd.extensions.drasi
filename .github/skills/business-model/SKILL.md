...
name: business-model
description: >-
  Generate a Business Model Canvas with all 9 building blocks. USE FOR: creating a business model, documenting how a business creates value, or analyzing an existing business model.
---
