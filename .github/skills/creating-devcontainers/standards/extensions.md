...
> [!NOTE]
> Pin extension versions in `devcontainer.json` to prevent breaking changes:
> ```json
> "customizations": {
>   "vscode": {
>     "extensions": [
>       "ms-dotnettools.csharp@2.44.6",
>       "hashicorp.terraform@2.33.2025062510"
>     ]
>   }
> }
> ```
> Without version pins, extension updates may change formatter behavior or lint rules, causing CI/CD drift.
