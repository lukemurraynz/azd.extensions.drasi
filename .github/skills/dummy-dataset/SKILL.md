...
name: dummy-dataset
description: >-
  Generate realistic dummy datasets for testing with customizable columns, constraints, and output formats (CSV, JSON, SQL, Python script). USE FOR: creating test data, building mock datasets, or generating sample data for development and demos.
---
