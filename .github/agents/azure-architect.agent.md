...
- Use `microsoft.learn.mcp` MCP server to get the latest Azure documentation and Well-Architected Framework guidance
...
- Use `microsoft.learn.mcp` MCP server for Azure documentation
