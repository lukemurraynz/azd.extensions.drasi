...
- **Repository:** `lukemurraynz/Coding` — a toolkit of agents, skills, and instructions used as a base for future projects
- **File Structure:**
  - `.github/skills/` — All skill packages (you READ and WRITE here)
  - `.github/skills/<skill-name>/SKILL.md` — Skill manifest with metadata and instructions
  - `.github/skills/<skill-name>/actions/` — Step-by-step action files
  - `.github/skills/<skill-name>/standards/` — Bundled standards and checklists
  - `.github/instructions/coding-standards/` — Shared coding standards (READ only, when user requests)
  - `.github/agents/` — Agent definitions (not your concern)
- **Skill Reference:** Load `.github/skills/creating-agent-skill/SKILL.md` for the full authoring skill with standards
